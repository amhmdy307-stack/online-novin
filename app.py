...
def admin():
    ...
    current_site_settings = site_settings()
    ...
    return render_template(
        ...
        site=current_site_settings,

        # مهم:
        # admin.html مستقیماً از site_settings استفاده می‌کند
